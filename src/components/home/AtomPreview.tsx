...
export function AtomPreview() {
  return (
    <div className="relative aspect-square w-full max-w-[26rem] select-none">
      ...
      <div className="glass-panel relative flex h-full w-full items-center justify-center overflow-hidden rounded-[2rem]">
        {/* Grid sheen */}
        <div
        ...
        <div className="relative flex h-[78%] w-[78%] items-center justify-center">
          <OrbitRing
            ...
            electronClass="bg-accent shadow-[0_0_12px_3px_var(--color-accent)]"
          />
          <OrbitRing
            sizeClass="h-[68%] w-[68%]"
            tiltClass="[transform:rotateX(72deg)_rotateZ(60deg)]"
            animation="var(--animate-orbit-medium)"
            electronClass="bg-accent-violet shadow-[0_0_12px_3px_var(--color-accent-violet)]"
          />
          <OrbitRing
            sizeClass="h-[40%] w-[40%]"
            tiltClass="[transform:rotateX(72deg)_rotateZ(-60deg)]"
            animation="var(--animate-orbit-fast)"
            electronClass="bg-accent-pink shadow-[0_0_12px_3px_var(--color-accent-pink)]"
          />

          {/* Nucleus */}
          <div className="relative h-16 w-16 animate-[var(--animate-float)] rounded-full bg-gradient-to-br from-accent via-accent-violet to-accent-pink shadow-[0_0_40px_-4px_var(--color-accent-violet)]">
